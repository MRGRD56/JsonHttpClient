...
namespace Mrgrd56.JsonHttpClient
{
    public static class HttpClientExtensions
    {
        ...
        public static async Task<TResponse> SendAsync<TResponse>(
            this HttpClient httpClient, Uri requestUri,
        ...
        public static Task<TResponse> SendAsync<TResponse>(
            ...
            HttpMethod method, object body = null)
        {
            return httpClient.SendAsync<TResponse>(new Uri(requestUri), method, body);
        }
        ...
        /// <returns>The object created from the JSON returned by the servers</returns>
        /// <exception cref="HttpException">Thrown if the response status code is not successful.</exception>
        public static async Task<TResponse> GetAsync<TResponse>(this HttpClient httpClient, Uri requestUri, object body = null) => 
            await httpClient.SendAsync<TResponse>(requestUri, HttpMethod.Get, body);
        ...
        /// <returns>The object created from the JSON returned by the servers</returns>
        /// <exception cref="HttpException">Thrown if the response status code is not successful.</exception>
        public static async Task<TResponse> PostAsync<TResponse>(this HttpClient httpClient, Uri requestUri, object body = null) => 
            await httpClient.SendAsync<TResponse>(requestUri, HttpMethod.Post, body);
        ...
        /// <returns>The object created from the JSON returned by the servers</returns>
        /// <exception cref="HttpException">Thrown if the response status code is not successful.</exception>
        public static async Task<TResponse> PutAsync<TResponse>(this HttpClient httpClient, Uri requestUri, object body = null) => 
            await httpClient.SendAsync<TResponse>(requestUri, HttpMethod.Put, body);
        ...
        /// <returns>The object created from the JSON returned by the servers</returns>
        /// <exception cref="HttpException">Thrown if the response status code is not successful.</exception>
        public static async Task<TResponse> DeleteAsync<TResponse>(this HttpClient httpClient, Uri requestUri, object body = null) => 
            await httpClient.SendAsync<TResponse>(requestUri, HttpMethod.Delete, body);
    }
}